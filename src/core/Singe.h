...
/** \brief code gerant un Singe qui est le protagoniste du jeu de survie qui utilise les classes Plateau Plante
 *
 * \param on a comme parametre les positions du singe "posX", "posY", le niveau de vie "q_vie", l'eau "leau" et le niveau de sante "niv_san"
 *
 */
