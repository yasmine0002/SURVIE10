...
//
//	int dimx, dimy;
//	dimx = jeu.getPlateau().getXmax();
//	dimy = jeu.getPlateau().getYmax();
//	dimx = dimx * TAILLE_SPRITE;
//	dimy = dimy * TAILLE_SPRITE;
//
//    // Creation de la fenetre
//    window = SDL_CreateWindow("SURVIE10", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, dimx, dimy, SDL_WINDOW_SHOWN | SDL_WINDOW_RESIZABLE);
//    if (window == nullptr) {
...
//	for (x=0;x<p.getXmax();++x)
//		for (y=0;y<p.getYmax();++y)
//			if (p.getXYasChar(x,y)=='#')
//				im_mur.draw(renderer,x*TAILLE_SPRITE,y*TAILLE_SPRITE,TAILLE_SPRITE,TAILLE_SPRITE);
////			else if (p.getXYasChar(x,y)=='.')
////				im_pastille.draw(renderer,x*TAILLE_SPRITE,y*TAILLE_SPRITE,TAILLE_SPRITE,TAILLE_SPRITE);
//
//	// Afficher le sprite de Pacman
//	im_pacman.draw(renderer,s.getPosX()*TAILLE_SPRITE,s.getPosY()*TAILLE_SPRITE,TAILLE_SPRITE,TAILLE_SPRITE);
//
//	// Afficher le sprite du Fantome
//	im_fantome.draw(renderer,X.getPosX()*TAILLE_SPRITE,X.getPosY()*TAILLE_SPRITE,TAILLE_SPRITE,TAILLE_SPRITE);
//
...
//        nt = SDL_GetTicks();
//        if (nt-t>500) {
//            jeu.mvtPoulet(events.key.keysym.scancode);
//            t = nt;
//        }
////
